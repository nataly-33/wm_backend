...
import com.workflow.security.JwtFilter;
import com.workflow.security.EnterpriseContextFilter;
...
public class SecurityConfig {
    ...
    @Autowired
    private EnterpriseContextFilter enterpriseContextFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/v1/documentos/presignado").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/v1/documentos/presignado-por-url").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/v1/archivos/subir").authenticated()
                ...
                .addFilterAfter(enterpriseContextFilter, JwtFilter.class);
